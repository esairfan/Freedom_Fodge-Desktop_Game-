...
namespace FreedomFodgeFrameWork
{
    public class Game
    {
        ...
        private void InitializeEnemiesLabel()
        {
            ...
            RemainingEnemiesLabel.ForeColor = Color.Black;
            RemainingEnemiesLabel.BackColor = Color.White;
            RemainingEnemiesLabel.AutoSize = true;
            RemainingEnemiesLabel.Location = new Point(Form.ClientSize.Width - RemainingEnemiesLabel.Width - 80, 50);
            UpdateEnemyLabel();
