...
namespace FreedomFodgeFrameWork
{
    public class Player :IMovement
    {
        ...
        private void InitializePlayerLivesLabel()
        {
            ...
            playerLivesLabel.ForeColor = Color.Black;
            playerLivesLabel.BackColor = Color.White;
            playerLivesLabel.AutoSize = true;
            playerLivesLabel.Location = new Point(form.ClientSize.Width - playerLivesLabel.Width - 10, 10); // Adjust location as needed
        ...
        private void InitializePlayerScoreLabel()
        {
            ...
            playerScoreLabel.BackColor = Color.White;
            playerScoreLabel.AutoSize = true;
            playerScoreLabel.Location = new Point(form.ClientSize.Width - playerScoreLabel.Width - 10, 40); 
